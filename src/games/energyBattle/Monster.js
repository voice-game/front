function Character(images, size, speed, life) {
  this.type = 0;
  this.images = images;
  this.size = size;
  this.speed = speed;
...
Character.prototype.getIsCollision = function (obstacles, shieldTime) {
...
Character.prototype.animate = function (ctx, volume, isCollision, frame) {
